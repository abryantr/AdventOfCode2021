...
public class Day2Dive {
	...
	public int calculatePart1() throws FileNotFoundException {
		int horiz = 0;
		int depth = 0;
		
		File file = new File("bin/Day2Input.txt");
	...
	would have after following the planned course. What do you get if you multiply your final horizontal position by your final depth?
	 */

	public int calculatePart2() throws FileNotFoundException {
		int horiz = 0;
		int depth = 0;
		int aim = 0;
